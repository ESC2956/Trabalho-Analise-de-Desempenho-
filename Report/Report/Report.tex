...
\and \alignauthor Erick Schultz Ceresa \\
        \affaddr{Universidade Federal do Rio Grande do Sul}\\
       \email{}
\and \alignauthor Miguel Predebon Abichequer \\
        \affaddr{Universidade Federal do Rio Grande do Sul}\\
       \email{}
\and }
...
\section{Abstração}\label{abstrauxe7uxe3o}

O presente trabalho analisa o desempenho do emulador de PlayStation 3
RPCS3 em diferentes configurações de hardware, utilizando o jogo The
Last of Us como carga de trabalho, por sua alta exigência computacional.
A métrica principal empregada foi o frametime, medido em ambiente
controlado (NixOS) para isolar variações de hardware. Foram comparados
dois processadores --- AMD Ryzen 9 9900X e Intel Core i5-10400F ---
variando o número de núcleos ativos entre 6, 8 e 12.

Os resultados mostram que a distribuição de carga entre mais núcleos
reduz a variabilidade de frametime, com 12 núcleos apresentando maior
estabilidade, embora outliers persistam mesmo nessa configuração ---
possivelmente associados à comunicação entre complexos de núcleos (CCDs)
do Ryzen. Na comparação entre arquiteturas, o Ryzen 9 9900X apresentou
desempenho 2,4x superior ao i5-10400F com o mesmo número de núcleos
ativos, atribuído a maior IPC, suporte a AVX-512 e clock mais elevado.
...
desativada; um barramento em anel que alimenta as SPEs com instruções e
dados, chamado Element Interconnect Bus; e por fim um processador
principal chamado de PPE, ou Power Processing Element. Todos com seu
próprio cache e instruções {[}\textbf{copetti-ps3?}{]}.
...
emulador seja sólida, mas que o hardware hospedeiro seja utilizado
eficientemente para que a emulação ocorra em velocidades interativas. O
...
grande disparidade entre a classe de desempenho da CPU comparada a GPU.

Este trabalho avalia experimentalmente a relação entre o número de
núcleos do processador host e a performance de emulação no emulador
RPCS3. Utilizando um dos jogos mais exigentes no hardware do Playstation
3, The Last of Us, utilizando o tempo entre a geração de cada quadro, ou
frametime, para contrastar a performance entre 6, 8 e 12 núcleos do
mesmo processador. Também comparamos duas arquiteturas de processador
com 6 núcleos.
...
A cena 2 apresenta um comportamento diferente da cena 1. Pode-se notar
que existe uma limitação no uso tanto da CPU, por ter utilização mais
baixa, quanto da GPU, que fica em torno de 50\% invés de 70\% como na
cena 1. Uma investigação dos ``gargalos'' presentes na emulação de
títulos que usam o hardware do Playstation 3 ao máximo poderia revelar
mais informações sobre essa limitação.

\begin{figure}

{\centering \includegraphics[width=0.85\linewidth]{Report_files/figure-latex/unnamed-chunk-3-1} 
...
{\centering \includegraphics[width=0.85\linewidth]{Report_files/figure-latex/unnamed-chunk-4-1} 
...
{\centering \includegraphics[width=0.85\linewidth]{Report_files/figure-latex/unnamed-chunk-5-1} 
...
{\centering \includegraphics[width=0.85\linewidth]{Report_files/figure-latex/unnamed-chunk-6-1} 
...
Advanced Micro Devices. \emph{AMD Ryzen 9 9900X Processor
Specifications}. 2024. Disponível em: \url{https://www.amd.com}. Acesso
em: 5 jul. 2026.

Copetti, Rodrigo. \emph{PlayStation 3 Architecture -- A Practical
Analysis}. 2021. Última atualização em 10 jun. 2026. Disponível em:
\url{https://www.copetti.org/writings/consoles/playstation-3/}. Acesso
em: 5 jul. 2026.

Intel Corporation. \emph{Intel Core i5-10400F Processor Specifications}.
2020. Disponível em: \url{https://www.intel.com}. Acesso em: 5 jul.
2026.

RPCS3 Team. \emph{RPCS3 -- PlayStation 3 Emulator}. 2025. Disponível em:
\url{https://rpcs3.net}. Acesso em: 5 jul. 2026.

RPCS3 Team. \emph{RPCS3 Quickstart Guide}. 2025. Disponível em:
\url{https://rpcs3.net/quickstart}. Acesso em: 5 jul. 2026.
